...
void LWDP::solve(const Graph& G, const std::vector<double>& pi, const std::vector<double>& wgt, const std::unordered_set<int>& srcs, std::vector<double>& res, bool reordering){
  allClear();
  ...
  int nn = Gn.numV();
  int mn = Gn.numE();
  std::vector<double> innerres(nn+1);
  std::vector<double> innerwgt0(wgt);
  std::vector<double> innerwgt(nn+1);
...
void LWDP::innerSolve(const Graph& G, const std::vector<double>& pi, const std::vector<double>& wgt, const std::unordered_set<int>& srcs, std::vector<double>& res){
  int n = G.numV();
  int m = G.numE();
...
void LWDP::innerSolveEmpty(const Graph& G, const std::vector<double>& pi, const std::vector<double>& wgt, std::vector<double>& res){
  int n = G.numV();
  int m = G.numE();
